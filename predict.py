...
def get_backtest_yeild_with_name(name, buy_cond, sell_cond, year, price_info_df,model):
    ...
    if model =="naive":
        model_path = "lgbm_model_0.30_0.29_iter_2198_day_5.pkl"
        
    elif model=="deep":
        model_path  = "lgbm_model_0.29_0.28_iter_2373_day_5.pkl"
        
    elif model=="robust":    
        model_path = "lgbm_model_0.28_0.28_iter_2806_day_5.pkl"
