...
def patten_to_vector_rate(analysis_day:int=params.ANALYSIS_DAY, period_yeild_day:int=params.PERIOD_YEILD_DAY, year_to_day:int=params.YEAR_TO_DAY,new_listing_reduction_year:int=params.NEW_LISTING_REDUCTION_YEAR):
    # 데이터 로드
    data_path =  "..\\data\\raw_data\\stock_price_data_all_period_20221209.pickle"
    ...
    # for idx in tqdm(range(1)):
        try:
            ...
            with open(f'..\\data\\raw_data\\Korea_stock_Dataset_{analysis_day}_{period_yeild_day}_{year_to_day}_{new_listing_reduction_year}_RATE_only.pkl', 'wb') as f:
