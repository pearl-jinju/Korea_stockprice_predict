...
vector_dataset = vector_dataset[(vector_dataset[5]<271)&(vector_dataset[5]>-85)]
...
def objective(trial):
    param = {
        ...
        'num_iterations' : trial.suggest_int('num_iterations', 2000, 3000),
        # 'num_iterations' : trial.suggest_int('num_iterations', 1, 2),
    ...
    joblib.dump(lgb_model, f"..\\model\\lgbm_model_{mae:.2f}_{mae_test:.2f}_iter_{param['num_iterations']}_day_{params.ANALYSIS_DAY}.pkl") 
    #===========================================================================================
    return mae_test
